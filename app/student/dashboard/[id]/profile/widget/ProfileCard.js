export default function ProfileCard({ profileImgData, onClick, currencyName, owned }) {
    ...
    return (
        ...
        owned
            ? <div className="relative">
                <div className="cursor-default w-[192px] h-[300px]  m-[16px]  flex flex-col justify-center items-center bg-orange-200 shadow-[4.4px_4.4px_1.2px_rgba(0,0,0,0.15)] rounded-lg">
