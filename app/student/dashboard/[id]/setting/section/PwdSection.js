    ...
    return (
        <div className="flex m-[20px] min-[600px]:p-[20px]  w-[280px] justify-center flex-col">
            ...
            <div>
                ...
                <input type="password" className="border-2 focus:outline-orange-500 w-[100%]" inputMode="numeric"
                    pattern="\d{4}"
                    maxLength={4} value={password.nextPassword} onChange={onPwdChange} name="nextPassword" />
            ...
            <div>
                ...
                <input type="password" inputMode="numeric"
                    pattern="\d{4}"
                    maxLength={4} className="border-2 focus:outline-orange-500 w-[100%]" value={password.nextPasswordConfirm} onChange={onPwdChange} name="nextPasswordConfirm" />
            </div>
