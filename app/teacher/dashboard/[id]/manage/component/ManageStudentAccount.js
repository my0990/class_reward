...
export default function CreateStudentAccount({ classId }) {
    ...
    return (
        <div>
            ...
            <PickNumber classData={classData} classId={classId} />
            <DeleteModal picked={picked} classId={classId}/>
