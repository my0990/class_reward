...
export default function FinishQuestModal({ rewardedUserData, questData, currencyName, clearAll, classId, setQuestDetailData }) {
    ...
    const onSubmit = (e) => {
        ...
        fetch("/api/finishQuest", {
            ...
            body: JSON.stringify({classId: classId, questData: questData, rewarded: rewardedUserData.map(obj => ({userId: obj.userId,money: obj.money})) }),
