...
export default function ItemBuy({ setStep, itemData, studentData, currencyName, currencyEmoji, teacher}) {
    const [isItemPicked, setIsItemPicked] = useState(false);
    const [requestData, setRequestData] = useState({ itemData: null, userId: null, userMoney: null , userName: null, checked: false, itemEmoji: null})
    ...
    return (
        !isPwdChecked
            ...
            : !isItemPicked
                ...
                : <ConfirmItemBuy requestData={requestData} setStep={setStep} currencyName={currencyName} currencyEmoji={currencyEmoji} teacher={teacher}/>
