    ...
    return (
        <div className="flex flex-col justify-center items-center h-[100vh] text-[1.5rem] bg-orange-100 relative overflow-hidden" >
            ...
            {thermometerData !== null
                ? <button onClick={() => setStepData({ menu: "thermometer", step: "thermometerBoard" })} className="btn px-[24px] w-[150px]"><span className="text-[1.5rem]">🌡️</span> 학급 온도계</button>
                : <button  className="hover:cursor-default opacity-50 hover:bg-gray-100 hover:border-0 outline-none btn px-[24px] w-[150px]"><span className="text-[1.5rem]">🌡️</span> 학급 온도계</button>}
