        ...
        <div className="flex justify-center">
            <div className=" w-[1024px]">
                <TransitionGroup noderef={nodeRef} className="flex p-[8px] flex-wrap">
                    ...
                    {role === 'teacher'
                        ? <div className="p-[16px] w-[192px] h-[344px]  cursor-pointer font-bold rounded-lg m-[16px] flex justify-center items-center relative bg-orange-200 shadow-[4.4px_4.4px_1.2px_rgba(0,0,0,0.15)] rounded-lg hover:scale-110 transition-all" onClick={() => document.getElementById('my_modal_2').showModal()}>
                            <div>
